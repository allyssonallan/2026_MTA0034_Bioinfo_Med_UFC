...
# Bioinformática aplicada à medicina
...
::: {.faculty-grid}
::: {.faculty-card}
![](assets/professores/allysson_placeholder.svg){.faculty-photo fig-alt="Espaço para foto de Allysson Allan de Farias"}
...
::: {.faculty-card}
![](assets/professores/felipe_placeholder.svg){.faculty-photo fig-alt="Espaço para foto de Felipe Pantoja Mesquita"}
...
::: {.faculty-card}
![](assets/professores/thalita_placeholder.svg){.faculty-photo fig-alt="Espaço para foto de Thalita Basso Scandolara"}
...
Substitua os cinco arquivos SVG abaixo pelos logos oficiais mantendo os mesmos nomes, ou altere os caminhos nesta seção.

::: {.logo-strip}
![](assets/logos/ufc_placeholder.svg){fig-alt="Logo UFC"}
![](assets/logos/npdm_placeholder.svg){fig-alt="Logo NPDM"}
![](assets/logos/lab1_placeholder.svg){fig-alt="Logo laboratório participante 1"}
![](assets/logos/lab2_placeholder.svg){fig-alt="Logo laboratório participante 2"}
![](assets/logos/lab3_placeholder.svg){fig-alt="Logo laboratório participante 3"}
:::
